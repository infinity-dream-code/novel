...
<body class="bg-gray-900 text-white min-h-screen">
        ...
        <div id="gameArea" class="max-w-4xl mx-auto">
            ...
            <div class="bg-gray-800 rounded-lg p-6 mb-6 fade-in">
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    <div class="bg-gray-700 p-4 rounded-lg">
                        ...
                        <p class="text-sm text-gray-300">Istri kedua Lord Blackwood. Menikah 2 tahun lalu. Diketahui sering bertengkar soal warisan.</p>
                    </div>
                    <div class="bg-gray-700 p-4 rounded-lg">
                        <h3 class="font-bold text-yellow-300">2. James Blackwood</h3>
                        <p class="text-sm text-gray-300">Anak dari pernikahan pertama. Memiliki utang judi yang besar dan butuh uang.</p>
                    </div>
                    <div class="bg-gray-700 p-4 rounded-lg">
                        <h3 class="font-bold text-yellow-300">3. Dr. Samuel Richards</h3>
                        <p class="text-sm text-gray-300">Dokter keluarga sekaligus teman lama. Punya akses ke berbagai obat dan racun.</p>
                    </div>
                    <div class="bg-gray-700 p-4 rounded-lg">
                        <h3 class="font-bold text-yellow-300">4. Helena Morrison</h3>
                        <p class="text-sm text-gray-300">Sekretaris pribadi selama 10 tahun. Mengetahui semua rahasia keluarga Blackwood.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-800 rounded-lg p-6 mb-6 fade-in">
                ...
                <div class="grid md:grid-cols-3 gap-4">
                    <div class="bg-gray-700 p-4 rounded-lg text-center">
                        ...
                        <p class="text-sm text-gray-300">Mengandung arsenik. Sidik jari terhapus.</p>
                    </div>
                    <div class="bg-gray-700 p-4 rounded-lg text-center">
                        <div class="text-3xl mb-2">💊</div>
                        <h4 class="font-bold">Botol Arsenik</h4>
                        <p class="text-sm text-gray-300">Ditemukan di kebun. Masih ada sisa.</p>
                    </div>
                    <div class="bg-gray-700 p-4 rounded-lg text-center">
                        <div class="text-3xl mb-2">📄</div>
                        <h4 class="font-bold">Surat Wasiat</h4>
                        <p class="text-sm text-gray-300">Baru dibuat minggu lalu. Isinya mengejutkan.</p>
                    </div>
                    <div class="bg-gray-700 p-4 rounded-lg text-center">
                        <div class="text-3xl mb-2">👠</div>
                        <h4 class="font-bold">Sepatu Hak Tinggi</h4>
                        <p class="text-sm text-gray-300">Ditemukan di taman dengan tanah segar.</p>
                    </div>
                    <div class="bg-gray-700 p-4 rounded-lg text-center">
                        <div class="text-3xl mb-2">📱</div>
                        <h4 class="font-bold">Pesan Terakhir</h4>
                        <p class="text-sm text-gray-300">"Hari ini semuanya akan berubah"</p>
                    </div>
                    <div class="bg-gray-700 p-4 rounded-lg text-center">
                        <div class="text-3xl mb-2">💰</div>
                        <h4 class="font-bold">Cek Kosong</h4>
                        <p class="text-sm text-gray-300">Sudah ditandatangani, belum diisi nominal.</p>
                    </div>
                </div>
            </div>
            ...
            <div id="questions" class="space-y-4">
                <div class="bg-gray-800 rounded-lg p-6 fade-in">
                    ...
                    <!-- Question 1 -->
                    <div class="mb-6">
                        <h3 class="text-lg font-bold mb-3">1. Siapa yang paling memiliki motif kuat untuk membunuh Lord Blackwood?</h3>
                        <div class="space-y-2">
                            <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-700 p-2 rounded">
                                ...
                                <span>Lady Margaret - karena masalah warisan</span>
                            </label>
                            <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-700 p-2 rounded">
                                <input type="radio" name="q1" value="b" class="text-blue-500">
                                <span>James - karena utang judi yang besar</span>
                            </label>
                            <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-700 p-2 rounded">
                                <input type="radio" name="q1" value="c" class="text-blue-500">
                                <span>Dr. Richards - karena rahasia medis</span>
                            </label>
                            <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-700 p-2 rounded">
                                <input type="radio" name="q1" value="d" class="text-blue-500">
                                <span>Helena - karena mengetahui terlalu banyak rahasia</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="space-y-2">
                            <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-700 p-2 rounded">
                                ...
                                <span>Pembunuh membuang botol arsenik di sana</span>
                            </label>
                            <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-700 p-2 rounded">
                                <input type="radio" name="q2" value="b" class="text-blue-500">
                                <span>Hanya kebetulan tertinggal</span>
                            </label>
                            <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-700 p-2 rounded">
                                <input type="radio" name="q2" value="c" class="text-blue-500">
                                <span>Pembunuh melarikan diri lewat taman</span>
                            </label>
                            <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-700 p-2 rounded">
                                <input type="radio" name="q2" value="d" class="text-blue-500">
                                <span>Untuk mengalihkan perhatian</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <!-- Question 3 -->
                    <div class="mb-6">
                        <h3 class="text-lg font-bold mb-3">3. Apa arti pesan "Hari ini semuanya akan berubah"?</h3>
                        <div class="space-y-2">
                            <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-700 p-2 rounded">
                                <input type="radio" name="q3" value="a" class="text-blue-500">
                                <span>Pembunuh akan mengeksekusi rencananya</span>
                            </label>
                            <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-700 p-2 rounded">
                                <input type="radio" name="q3" value="b" class="text-blue-500">
                                <span>Lord Blackwood akan mengubah wasiat</span>
                            </label>
                            <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-700 p-2 rounded">
                                <input type="radio" name="q3" value="c" class="text-blue-500">
                                <span>Ada perubahan besar dalam keluarga</span>
                            </label>
                            <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-700 p-2 rounded">
                                <input type="radio" name="q3" value="d" class="text-blue-500">
                                <span>Seseorang akan dibongkar rahasianya</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <!-- Question 4 -->
                    <div class="mb-6">
                        <h3 class="text-lg font-bold mb-3">4. Mengapa cek kosong sudah ditandatangani?</h3>
                        <div class="space-y-2">
                            <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-700 p-2 rounded">
                                <input type="radio" name="q4" value="a" class="text-blue-500">
                                <span>Lord Blackwood akan membayar utang James</span>
                            </label>
                            <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-700 p-2 rounded">
                                <input type="radio" name="q4" value="b" class="text-blue-500">
                                <span>Untuk membayar seseorang agar diam</span>
                            </label>
                            <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-700 p-2 rounded">
                                <input type="radio" name="q4" value="c" class="text-blue-500">
                                <span>Bonus untuk Helena yang setia</span>
                            </label>
                            <label class="flex items-center space-x-2 cursor-pointer hover:bg-gray-700 p-2 rounded">
                                <input type="radio" name="q4" value="d" class="text-blue-500">
                                <span>Hadiah ulang tahun untuk Lady Margaret</span>
                            </label>
                        </div>
                    </div>
    ...
    <script>
        ...
        function submitAnswer() {
            ...
            // Correct answers: q1=b (James), q2=a (buang botol), q3=d (rahasia dibongkar), q4=b (bayar diam), killer=helena
            const correctAnswers = {
                q1: 'd', // Helena mengetahui rahasia
                q2: 'a', // Membuang botol arsenik
                q3: 'd', // Rahasia akan dibongkar
                q4: 'b', // Membayar seseorang agar diam
                killer: 'helena'
            };
            ...
            if (correctCount === totalQuestions) {
                ...
                swal({
                    ...
                    text: "Selamat! Anda berhasil mengungkap bahwa Helena Morrison adalah pembunuhnya. Dia membunuh Lord Blackwood karena takut rahasianya tentang penggelapan uang akan dibongkar. Key: mantap nabila",
                    icon: "success",
                    button: "Tutup"
                });
